    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/forgot-password","/forgotPassword","/api/auth/reset-password","/appointment").permitAll()
                        ...
                        .requestMatchers("/appointment/**").hasAnyAuthority("ROLE_PATIENTS", "ROLE_DOCTOR", "ROLE_ADMIN")
                        ...
                        .requestMatchers("api/medicalRecords/history","/userHome","/addPastmedical").hasAuthority("ROLE_PATIENTS")
